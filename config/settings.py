...
SECRET_KEY = "django-insecure-(6*nun*u#uayr+4csz9s=%9&s*$ug!lx=5ddiouo@pg0+%139f"
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'project/02/staticfiles'),  # Adjust this to match the actual path of your static files
]
